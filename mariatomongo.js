...
const atlas = 'mongodb+srv://daniil:Uusi2571@testi.ghjft66.mongodb.net/?appName=testi';
const dbMongo = "testi";
...
const createCollections = async (usersData, dataData) => {
    ...
    const dbServer = new MongoClient(atlas);
    try {
        ...
        const processedData = dataData.map(item => {
            return {
                _id: ObjectId.createFromHexString(item.id.toString(16).padStart(24, '0')),
